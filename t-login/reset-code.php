          ...
          <div class="container">
            <div class="row">
              <div class="col-md-5 col-md-push-4">
                ...
                <h2 align="center">Code Verification</h2>
                    <?php 
                    ...
                    ?>
                <form action="reset-code.php" method="POST" name="login-form" class="clearfix">
                  <div class="row">
                    <div class="form-group col-md-12">
                      <div class="input-group">
                      <input type="number" name="otp" placeholder="Enter code" required  class="form-control" data-height="51px" id="username">
                      <span class="input-group-btn">
                          <button type="button" class="btn btn-default"><i class="pe-7s-info text-theme-colored font-24 mt-5"></i></button>
                      </span>
             
                    </div>
                    </br>
                    <button type="submit" name="check-reset-otp" class=" form-control btn btn-colored btn-theme-colored btn-lg border-left-theme-color-2-4px">Send Password Reset Link</button>
                    </div>
                  </div>
                  </div>
                  <div>
