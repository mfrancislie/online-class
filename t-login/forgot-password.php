                ...
                <form action="forgot-password.php" method="POST" name="login-form" class="clearfix">
                  <div class="row">
                    <div class="form-group col-md-12">
                      ...
                      <input type="text" value="<?php echo $email ?>" name="email" placeholder="Enter Email Address"  class="form-control" data-height="49px" id="username">
                    ...
                    <button type="submit" name="check-email" class=" form-control btn btn-colored btn-theme-colored btn-lg border-left-theme-color-2-4px">Send Password Reset Link</button>
                    </div>
