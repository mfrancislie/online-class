                ...
                <div class="text-center mb-80"><a href="#" class=""><img alt="" src="../images/logo-wide1.png"></a></div>
                 <h3 align="center">Reset password<span class="text-theme-color-2"> </span></h3>
                   <?php 
                    ...
                    ?>
                <form action="teachers_login.php" method="POST" name="login-form" class="clearfix">
                    <button type="submit" name="login-now" class=" form-control btn btn-colored btn-theme-colored btn-lg border-left-theme-color-2-4px">Login Now</button>
                </form>
              </div>
            </div>
          </div>
