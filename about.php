        ...
        <div class="section-content">
          <div class="row mt-10">
            <div class="col-sm-12 col-md-6 mb-sm-20 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.5s">
              <h3 class="text-uppercase mt-15">ACLC COLLEGE OF <span class="text-theme-color-2">  MANDAUE</span></h3>
        
              <p class="mb-15">ACLC College Mandaue is one of the branches of ACLC situated in Mandaue, Cebu, and part of AMA Education System. It offers undergraduate programs such as Business Administration, Information Technology, Computer Science, Accountancy,  Accounting Information Systems, and Hotel and Restaurant Management. 
               </p>
               <p class="mb-16">
                It offers academic tracks such as General Academic Strand (GAS), Humanities and Social Sciences (HUMSS), Accountancy, Business, and Management (ABM) as well as Technical-Vocational Livelihood track for its senior high school program.
                </p>
              <a class="btn btn-colored btn-theme-colored btn-lg text-uppercase font-13 mt-0" disabled="disabled" href="#">View Details</a> 
            </div>
            <div class="col-sm-12 col-md-6 mt-10 wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.5s">
             <video width="600" height="400" controls autoplay style="margin-top:-7vh;">
              <source src="images/about/Facebook.mp4" type="video/mp4">
