            ...
            <div class="row">
              <div class="col-md-5 col-md-push-4">
                <div class="text-center mb-80"><a href="#" class=""><img alt="" src="images/logo-wide1.png"></a></div>
                 <h3 align="center">Reset password<span class="text-theme-color-2"> </span></h3>
                 <?php
                  ...
                  ?>
                <form action="forgot-password.php" method="POST" name="login-form" class="clearfix">
                  <div class="row">
                    <div class="form-group col-md-12">
                      <label>Email Address</label>
                      <div class="input-group">
                      <input type="text" value="" name="email" placeholder="Enter Email Address"  class="form-control" data-height="49px" id="username">
                  ...
                  <div>
                    <div class="form-group col-md-5" style="margin-top: 40vh;margin-left:-15vh;">
                    <button type="submit" name="password_reset_link" class=" form-control btn btn-colored btn-theme-colored btn-lg border-left-theme-color-2-4px">Send Password Reset Link</button>
                    </div>
                  </div>
                </form>
              </div>
