    ...
    <section class="inner-header divider parallax layer-overlay overlay-dark-5" data-bg-img="images/bg/bg6.jpg">
      <div class="container pt-70 pb-20">
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-12">
              <h2 class="title text-white text-center">Here are the in-demand and affordable course </h2>
          ...
          <div class="col-md-9 blog">
            <div class="row mb-15">
              <div class="col-sm-6 col-md-4">
                <div class="thumb"> <img alt="featured project" src="images/services/g1.jpg" class="img-fullwidth"></div>
              </div>
              <div class="col-sm-6 col-md-8">
                <h4 class="line-bottom mt-0 mt-sm-20">BS in Accountancy</h4>
                <ul class="review_text list-inline">
                  <li><h4 class="mt-0"><span class="text-theme-color-2">Total Fee :</span> &#8369; 13,785</h4></li>
                 
                </ul>
                <p>The Bachelor of Science in Accountancy (BSA) is a four-year program which provides general accounting education to learners who wish to pursue a professional career as accountants, particularly as public accountants for the civil service.</p>
                <a class="btn btn-dark btn-theme-colored btn-sm text-uppercase mt-10" disabled="disabled" href="#">view details</a>
              </div>
            </div>
            <hr>
            <div class="row mb-15">
              <div class="col-sm-6 col-md-4">
                <div class="thumb"> <img alt="featured project" src="images/services/g2.jpg" class="img-fullwidth"></div>
              </div>
              <div class="col-sm-6 col-md-8">
                <h4 class="line-bottom mt-0 mt-sm-20">BS in Accounting Information System</h4>
                <ul class="review_text list-inline">
                  <li><h4 class="mt-0"><span class="text-theme-color-2">Total Fee :</span> &#8369; 13,785</h4></li>
                  
                </ul>
                <p>The program Bachelor of Science in Accounting Information System (BSAIS) meets the minimum requirements under CMO Number 30, Series of 2017, entitled “Policies, Standards and Guidelines for the Bachelor of Science in Accounting Information System,” and complies with the most recent competency framework of the International Education Standards (IES) issued by the International Federation of Accountants (IFAC). The graduates of this program shall be categorized as belonging to Level 6 of the Philippine Qualifications Framework and ASEAN Qualifications Framework and qualify to take assessments leading to certifications in Accounting Information System given by global professional accounting information system organizations.</p>
                <a class="btn btn-dark btn-theme-colored btn-sm text-uppercase mt-10" href="#" disabled="disabled">view details</a>
              </div>
            </div>
            <hr>
            <div class="row mb-15">
              <div class="col-sm-6 col-md-4">
                <div class="thumb"> <img alt="featured project" src="images/services/g3.jpg" class="img-fullwidth"></div>
              </div>
              <div class="col-sm-6 col-md-8">
                <h4 class="line-bottom mt-0 mt-sm-20">BS in Business Administration</h4>
                <ul class="review_text list-inline">
                  <li><h4 class="mt-0"><span class="text-theme-color-2">Total Fee :</span> &#8369; 13,785</h4></li>
                  
                </ul>
                <p>The Bachelor of Science in Business Administration program offers a wide range of specialized majors, namely Business Economics, Financial Management, Human Resource Management, and Marketing Management. The program focuses on the interrelationship of the different functional areas of business.</p>
                <a class="btn btn-dark btn-theme-colored btn-sm text-uppercase mt-10" href="#" disabled="disabled">view details</a>
              </div>
            </div>
            <hr>
            ...
            <div class="row mb-15">
              <div class="col-sm-6 col-md-4">
                <div class="thumb"> <img alt="featured project" src="images/services/g5.jpg" class="img-fullwidth"></div>
              </div>
              <div class="col-sm-6 col-md-8">
                <h4 class="line-bottom mt-0 mt-sm-20">BS in Computer Science</h4>
                <ul class="review_text list-inline">
                  <li><h4 class="mt-0"><span class="text-theme-color-2">Total Fee :</span> &#8369; 16,000</h4></li>
            ...
            <div class="row mb-15">
              <div class="col-sm-6 col-md-4">
                <div class="thumb"> <img alt="featured project" src="images/services/g6.jpg" class="img-fullwidth"></div>
              </div>
              <div class="col-sm-6 col-md-8">
                <h4 class="line-bottom mt-0 mt-sm-20">BS in Information Technology</h4>
                <ul class="review_text list-inline">
                  <li><h4 class="mt-0"><span class="text-theme-color-2">Total Fee :</span> &#8369; 16,000</h4></li>
