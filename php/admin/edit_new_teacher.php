...
if (isset($_POST['update'])) 
{
  ...
  $result = mysqli_query($conn, $sql);
       ...
       $query= "UPDATE `teachers` SET username='$username', password='$password', firstname='$firstname', lastname='$lastname', gender='$gender', address='$address', contacts='$contacts', email='$email' WHERE id='$id'";
                     ...
                     <div class="form-group col-md-6">
                      ...
                      <div class="form-group row">
                        <div class="offset-sm-2 col-sm-10">
                          <button type="submit" name="update" class="hvr-pop btn btn-danger" style="margin-left: -15vh">Update Now</button>
                        </div>
                      </div>
                    </form>
                  </div>
...
if (isset($_POST['update'])) 
{
  ...
  $result = mysqli_query($conn, $sql);
      ...
      $query= "UPDATE `teachers` SET role='$role', username='$username', password='$password', firstname='$firstname', lastname='$lastname', gender='$gender', address='$address', contacts='$contacts', email='$email' WHERE id='$id'";
      $result = mysqli_query($conn , $query) or die(mysqli_error($conn)); 
        if (mysqli_affected_rows($conn) > 0)
        {
          echo "<script>alert('SUCCESSFULLY UPDATED');
