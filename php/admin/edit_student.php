<?php 
   ...
   include "../db_conn.php";
    ...
    if (isset($_SESSION['username']) && isset($_SESSION['id'])) {  
      $id = $_GET['ID'];  
      $update=mysqli_query($conn, "SELECT * FROM students WHERE id = '$id'"); 
    ...
    if (isset($_POST['updated'])) 
{
  ...
  $result = mysqli_query($conn, $sql);
       ...
       $query= "UPDATE `students` SET username='$username', password='$password', firstname='$firstname', lastname='$lastname', gender='$gender', course='$course', address='$address', contacts='$contacts', email='$email' WHERE id='$id'";
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="admin_dashboard.php" class="nav-link">Dashboard</a></li>
              <li class="breadcrumb-item active nav-link">User Profile</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                  ...
                  <div class="icon-box mb-0 p-0">  
                     ...
                     <div class="form-group col-md-4">
                      ...
                      <label>Course</label>
                        <select class="form-control" name="course" id="course">
                          <option>-Select-</option>
                          <option value="BSIT" <?php echo($urow['course'] == "BSIT")? 'selected' : '';?>>BSIT</option>
                          <option value="HRM" <?php echo($urow['course'] == "HRM")? 'selected' : '';?>>HRM</option>
                        </select>
                     </div>
                    ...
                    <label>Year</label>
                      <select class="form-control" name="year" id="year">
                        <option>-Select-</option>
                        <option value="1st" <?php echo($urow['year'] == "1st")? 'selected' : '';?>>1st</option>
                        <option value="2nd" <?php echo($urow['year'] == "2nd")? 'selected' : '';?>>2nd</option>
                        <option value="3rd" <?php echo($urow['year'] == "3rd")? 'selected' : '';?>>3rd</option>
                        <option value="4th" <?php echo($urow['year'] == "4th")? 'selected' : '';?>>4th</option>
                     ...
                     <div class="form-group col-md-6">
                      ...
                      <div class="form-group row">
                        <div class="offset-sm-2 col-sm-10">
                          <button type="submit" name="updated" class="btn bg-gradient-warning" style="margin-left: -15vh">Update Now</button>
                        </div>
                      </div>
                    </form>
                  </div>
