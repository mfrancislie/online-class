...
<div class="row">
  <div class="col-lg-3">
   <div class="list-group">
      ...
      <a href="Manage_events.php" class="list-group-item list-group-item-action"><i class="fas fa-fw fa-calendar-alt"></i> SCHOOL CALENDAR</a>
  ...
  <div class="col-lg-9">
    <h1><a href="teacher.php"><i class="fas fa-tachometer-alt"></i>  Dashboard</a> <small>Satistics Overview</small></h1>
