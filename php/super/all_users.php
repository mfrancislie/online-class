...
<div class="row" style="margin-left:-15vh">
  <div class="col-lg-3">
   <div class="list-group">
     <a href="super_dashboard.php" class="list-group-item list-group-item-action active" style="background: #2E3191;font-family: Century Gothic;font-weight: 600">
      ...
      <a href="all_users.php" class="list-group-item list-group-item-action"><i class="fa fa-users"></i> ALL USERS</a>
  ...
  <div class="col-lg-9">
    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="row1">
        <button type="button" class="btn bg-gradient-primary" data-toggle="modal" data-target="#addadmin">
          <i class="fa fa fa-plus"></i> ADD NEW ADMIN
        </button>
        <a href="print_pdf_teacher.php" class="d-none d-sm-inline-block btn btn-sm btn-warning shadow-sm" style="margin-left: 85%"><i class="fas fa-download fa-md text-white-50"></i> Users List</a>
       </div>
...
<?php include 'add_admin_user.php';?>
    </div>
  </div>
  <!-- /.col-md-6 -->
</div>
