...
$(document).ready(function () {
    var calendar = $('#stud_calendar').fullCalendar({
        editable: true,
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if(parseInt(response) > 0) {
                            $('#stud_calendar').fullCalendar('removeEvents', event.id);
...
<body class="hold-transition layout-top-nav">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light" style="background: #D40000; margin-top:-8vh;">
  <!-- Left navbar links -->
  ...
  <div class="content-wrapper" style="background-image: url(back.jpg);">
...
<div class="list-group" style="text-align:left;">
      ...
      <a href="../classrooms.php" class="list-group-item list-group-item-action"><i class="fas fa-fw fa-file-alt"></i> CLASSROOM</a>
  ...
  <div class="col-lg-9">
    <h1><a href="../admin_dashboard.php" style="margin-left: -75vh;">Dashboard</a> <small>Calendar</small></h1>
...
<div class="card col-lg-9" style="margin-top:-20vh; margin-left:43vh;">
   <div class="card-header">
          <h3 class="card-title">School Calendar</code></h3>
        </div>
<div id='stud_calendar'></div>
<!-- jQuery -->
