...
<body class="hold-transition1 layout-top-nav">
<div class="wrapper">
  ...
  <div class="col-lg-9">
    ...
    <div class="card">
        <div class="card-header">
          <h3 class="card-title">Your Classrooms for this Semester</h3>
        </div>
      <div class="card-body">
        ...
        <tbody>
              <?php
        $id=$_SESSION['id'];
        $edit=mysqli_query($conn,"select * from students where id='".$id."'");
         while ($erow=mysqli_fetch_array($edit)) {
          $username = $erow['username'];
          $edit2=mysqli_query($conn,"select * from students where username='".$username."'");
         while ($erow2=mysqli_fetch_array($edit2)) {
          $usn=$erow2['usn'];
          $edit3=mysqli_query($conn,"select * from participants where usn='".$usn."'");
         while ($erow3=mysqli_fetch_array($edit3)) {
           ?>
            <tr>
               <td><?php echo $erow3['id'];?></td>
               <td><a href="subject_classroom.php?subject=<?php echo $erow3['subject'];?>"><?php echo $erow3['subject'];?></a></td>
               <td><?php echo $erow3['sem_code'];?></td>
            </tr>
            <?php
