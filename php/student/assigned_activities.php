 ...
 <div class="list-group">
  ...
  <div class="card">
        <div class="card-header">
          <h3 class="card-title">List of your Submitted Activities</h3>
        </div>
        <div class="card-header">
          <h4 class="card-title" style="color:red;">0 grade means not graded yet</h4>
        </div>
      <div class="card-body">
       ...
       <br/>
        ...
        <tbody>
        <?php
        $sql=mysqli_query($conn,"select * from submitted_activities where uid='".$_SESSION['id']."' ");
