...
include "../db_conn.php";
$id = $_GET['id'];  
$update=mysqli_query($conn, "SELECT * FROM exam WHERE id = '$id'"); 
 ...
 if (isset($_POST['edit']))
  {
    ...
    $subject = $_POST['subject'];
          ...
          $query= "UPDATE `exam` SET question='$question', answer='$answer', choice1='$choice1', choice2='$choice2', choice3='$choice3', subject='$subject' WHERE id='$id'";
          $result = mysqli_query($conn , $query) or die(mysqli_error($conn)); 
          if (mysqli_affected_rows($conn) > 0)
          {
            echo "<script>alert('SUCCESSFULLY UPDATED');
            window.location.href='exam.php?subject=$subject';</script>";
          }
          else 
          {
