  ...
  <div class="col-lg-9">
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        data-toggle="modal"
        data-target="#classroom" style="background-color:#2E3191; ">
        Create Classroom
        </button>
       </div>
       ...
       <?php
        $id=$_SESSION['id'];
        $edit=mysqli_query($conn,"select * from classrooms where teacher='".$id."'");
         while ($erow=mysqli_fetch_array($edit)) {
        ?>
            <tr>
               <td><?php echo $erow['id'];?></td>
               <td><a href="subject_classroom.php?subject=<?php echo $erow['subject'];?>"><?php echo $erow['subject'];?></a></td>
               <td><?php echo $erow['sem_code'];?></td>
            </tr>
            <?php
              }
            ?>
